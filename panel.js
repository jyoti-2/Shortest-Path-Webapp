    ...
    getFinder: function() {
        ...
        case 'astar_header':
            ...
            heuristic = $('input[name=astar_heuristic]:checked').val();
			 /* Based on biDirectional we are passing the values to PF */
            if (biDirectional) {
                finder = new PF.BiAStarFinder({
                    allowDiagonal: allowDiagonal,
                    dontCrossCorners: dontCrossCorners,
                    heuristic: PF.Heuristic[heuristic], /* PF. represents the Path finder library */
                    weight: weight
                });
            } else {
        ...
        case 'ida_header':
			...
			// Ida header has extra timeliit and all.
